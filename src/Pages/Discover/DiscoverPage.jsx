...
function DiscoverPage() {
	...
	return <Template activePage="discover" bodyLeft={<MyDayPanel tasks={tasks} />} bodyCenter={<MainList type="project" listItems={projects} />} bodyRight={<Submenu menuItems={menuItems} />} />;
}
