...
function ProjPage() {
	const menuItems = [
		...
		},
		{
			...
			selected: false,
			clicked: () => {
				console.log('clicked Leave Project');
			},
		},
		{
			isRoute: false,
	...
	const project = {
		...
		descr: (
			<>
				<p className="advent-font">
					Project is lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas sodales libero sit amet lacus varius, id tincidunt risus posuere. Mauris velit sem, pulvinar id hendrerit et,
					malesuada sed quam.
				</p>
				<p className="advent-font">
					Sum dolor sit amet, consectetur adipiscing elit. Maecenas sodales libero sit amet lacus varius, id tincidunt risus posuere. Mauris velit sem, pulvinar id hendrerit et, malesuada sed quam.
				</p>
				<p className="advent-font">Maecenas sodales libero sit amet lacus varius</p>
			</>
		),
	};

	return <Template activePage="" bodyLeft={<ProjPanel project={project} />} bodyCenter={<ProjMain project={project} />} bodyRight={<Submenu menuItems={menuItems} />} />;
}
